...
func main() {
	...
	producer := service.NewKafkaProducerWrapper("grpc_quote_realtime3", 0, []string{"localhost:9092"})
	...
	consumer := service.NewKafkaConsumerWrapper("grpc_quote_realtime2", 0, []string{"localhost:9092"})
